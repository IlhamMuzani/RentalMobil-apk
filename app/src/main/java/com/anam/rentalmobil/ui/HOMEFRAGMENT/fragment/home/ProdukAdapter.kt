package com.anam.rentalmobil.ui.HOMEFRAGMENT.fragment.home
...
import com.anam.rentalmobil.ui.HOMEFRAGMENT.fragment.detailproduk.DetailprodukActivity
...
class ProdukAdapter (val context: Context, var dataProduk: ArrayList<DataProduk>,
    ...
    class ViewHolder(view: View) : RecyclerView.ViewHolder(view) {
        ...
        fun bing(dataproduk: DataProduk) {
            view.txvMobil.text = dataproduk.nama
            view.txvModel.text = dataproduk.warna
            view.txvHarga.text = dataproduk.sewa
        }
    }
