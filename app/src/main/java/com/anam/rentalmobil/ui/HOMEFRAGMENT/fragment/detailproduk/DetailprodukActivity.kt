...
import kotlinx.android.synthetic.main.activity_pelanggantrans.*
import kotlinx.android.synthetic.main.adapter_produk.*
...
class DetailprodukActivity : AppCompatActivity(), DetailprodukContract.View {
    ...
    override fun onResult(responseProduk: ResponseProduk) {
        ...
        GlideHelper.setImage( applicationContext,Constant.IP_IMAGE + produk.gambar!!, imvgambardetail)
        txvnama.text = produk.nama
        txvwarna.text = produk.warna
        txvtahun.text = produk.tahun
        txvkapasitas.text = produk.kapasitas
        txvfasilitas.text = produk.fasilitas
        txvplat.text = produk.plat
